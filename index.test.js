...
const captures = [game1Captures, game2Captures, game3Captures, game4Captures];

test("final squares of chess pieces should be equal", () => {
  for (let i = 0; i < games.length; i++) {
    expect(objectEquals(processGame(games[i]), captures[i])).toBe(true);
  }
});
// TODO: Add more tests for verbose option
